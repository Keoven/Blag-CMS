...
class ArticleTest < ActiveSupport::TestCase
  ...
  test 'should fail validation due to absence of title' do
    assert_equal false, @a_no_title.save
  end

  test 'should fail validation due to absence of body' do
    assert_equal false, @a_no_body.save
  end

  test 'should either have Draft or Posted as value of status' do
  ...
  test 'should have all statuses in constant Article::STATUSES' do
